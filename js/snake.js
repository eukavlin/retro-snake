        ...
        me.handleDeath = function() {
            function recordScore () {
                ...
                if (me.snakeLength > highScore) {
                    elmAboutPanel.innerHTML = "High score : " + highScore;
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            mySnake = new SNAKE.Snake({playingBoard:me,startRow:10,startCol:10});
            myFood = new SNAKE.Food({playingBoard: me});
            
            elmWelcome.style.zIndex = 1;
        }
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "<h1>Makey Snake</h1><p></p> Use the arrow keys of the Makey Makey (or your keyboard) to move the snake<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "<h1>You died :(</h1><p></p>But I'm sure you can do better !<p></p>";
